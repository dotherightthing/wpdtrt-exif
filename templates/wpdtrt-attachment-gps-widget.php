 ...
 *    WP Admin > Appearance > Widgets > WPDTRT Attachment GPS
 *
...
<p>
  ...
  <span id="<?php echo $this->get_field_name('number'); ?>-tip" class="wpdtrt-attachment-gps-tip">Minimum: 1 | Maximum: <?php echo count($wpdtrt_attachment_gps_data); ?></span>
</p>
